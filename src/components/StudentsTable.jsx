    ...
    <table className="relative w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        key={student.id}>
         ...
         <tr 
            ...
            className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 hover:dark:bg-gray-800">
                ...
                <td className="px-6 py-4 z-10">
                    ...
                    className="font-medium text-blue-600 dark:text-blue-500 hover:underline px-10 pt-5 z-10">Edit</button>
